...
public class SolutionOutPutOptimum {
	...
	public SolutionOutPutOptimum(List<? extends Solution<?>> solutionList) {
	...
	public SolutionOutPutOptimum setVarFileOutputContext(FileOutputContext fileContext) {
		varFileContext = fileContext;

		return this;
	}

	public SolutionOutPutOptimum setFunFileOutputContext(FileOutputContext fileContext) {
		funFileContext = fileContext;

		return this;
	}

	public SolutionOutPutOptimum setObjectiveMinimizingObjectiveList(List<Boolean> isObjectiveToBeMinimized) {
		this.isObjectiveToBeMinimized = isObjectiveToBeMinimized;

		return this;
	}

	public SolutionOutPutOptimum selectFeasibleSolutions() {
		selectFeasibleSolutions = true;
		return this;
	}

	public SolutionOutPutOptimum setSeparator(String separator) {
