...
public class GenerationalDistanceEdited<S extends Solution<?>> extends GenericIndicator<S> {
  private double pow = 2.0;

  /**
   * Default constructor
   */
  public GenerationalDistanceEdited() {
  }
   ...
   */
  public GenerationalDistanceEdited(String referenceParetoFrontFile, double p) throws FileNotFoundException {
   ...
   * @throws FileNotFoundException
   */
  public GenerationalDistanceEdited(String referenceParetoFrontFile) throws FileNotFoundException {
   ...
   */
  public GenerationalDistanceEdited(Front referenceParetoFront) {
  ...
  public double generationalDistance(Front front, Front referenceFront) {
    double sum = 0.0;
    System.out.println("ReferenceFront is "+referenceFront);
